    ...
    >
      <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
        ...
        >
          ...
          <span>
            質問 {C_QUESTION.idx} / {C_QUESTION.total}
          </span>
        </div>
        <h2 className="q-heading" style={{ margin: 0 }}>
          {C_QUESTION.prompt}
        </h2>
        <p
          style={{
      ...
      >
        ...
        <span className="muted text-xs">
          この回答は{" "}
          <strong style={{ color: "var(--ink-2)" }}>損切り条件</strong>{" "}
          フィールドに反映されます
        </span>
      </div>
    </div>
    ...
    <div>
      {C_UNRESOLVED.map((u, i) => (
        ...
        >
          <div
            className="mono"
            style={{ width: 24, fontSize: 12, color: "var(--muted-2)" }}
          >
          ...
          <div style={{ flex: 1 }}>
            ...
            <div className="muted text-xs">ルール草案 · {u.field}</div>
          </div>
      ...
      {C_WARNINGS.map((w) => (
        <div key={w.id} className="severity-row">
          ...
          <div style={{ minWidth: 0 }}>
            ...
            >
              <span
                className={`pill ${w.sev === "Blocker" ? "pill-rose" : "pill-amber"}`}
              >
                <span className="dot" />
                {w.sev}
              </span>
...
function CalmEvidence() {
  return (
    ...
    >
      ...
      >
        <div className="evidence-cell" style={{ padding: "14px 18px" }}>
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span style={{ color: "var(--faint)" }}>/</span>
        <span className="muted text-sm">ルール設計</span>
        <span style={{ color: "var(--faint)" }}>/</span>
            ...
            <div className="calm-tabs">
              {TABS.map((t) => (
                ...
                >
                  {t.label}
                  {t.count != null && (
                    <span className={`count ${t.urgent ? "rose" : ""}`}>
                      {t.count}
                    </span>
                  )}
                </button>
        ...
        <aside className="calm-rail">
          <div className="calm-stat">
            ...
            <div className="value tabular">
              72<span className="den">/ 100</span>
            </div>
            ...
            <div className="sub">
              承認可能ラインは{" "}
              <strong style={{ color: "var(--ink-2)" }}>80</strong>。あと 8 点。
            </div>
          </div>
          ...
          >
            <div className="label" style={{ color: "var(--rose-ink)" }}>
              Blocker
            </div>
            <div className="value tabular" style={{ color: "var(--rose-ink)" }}>
              1
              <span
                className="den"
                style={{ color: "var(--rose-ink)", opacity: 0.6 }}
              >
                件
              </span>
            </div>
            <div
              className="sub"
              style={{ color: "var(--rose-ink)", opacity: 0.85 }}
            >
              バックテスト未実施。承認前に評価が必要です。
            </div>
            <button
      ...
      >
        ...
        >
          <div>
            ...
            <div className="mono muted text-xs">/ 6758</div>
          </div>
          <StatusPill status="Blocked" />
        </div>
      </div>
      ...
      <div className="col-scroll" style={{ flex: 1 }}>
        ...
        <div className="calm-mobile-section">
          ...
          <div
            ...
            style={{ fontSize: 30, fontWeight: 600, marginTop: 6 }}
          >
            72
            <span
              style={{ color: "var(--muted-2)", fontSize: 16, fontWeight: 400 }}
            >
              {" "}
              / 100
            </span>
