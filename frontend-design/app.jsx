  ...
  return (
    ...
    >
      ...
      >
        ...
        <div style={{ flex: 1 }} />
        <span className="muted text-xs">セッション開始: 2026/05/14 10:42</span>
        ...
        >
          ...
          <div className="card">
            <div className="card-header">
              <h3>質問キュー</h3>
              <span className="muted text-xs">9 件</span>
            </div>
            <div>
              {[
                {
                ...
                >
                  <div className="left">
                    ...
                    <div style={{ minWidth: 0 }}>
                      ...
                      <div className="muted text-xs">{q.c}</div>
                    </div>
                  </div>
                  <button className="btn btn-sm btn-ghost">
                    <I.ArrowRight />
    ...
    >
      <div style={{ flex: 1 }}>
        ...
        >
          {title}{" "}
          {count != null && (
            <span className="mono muted text-xs">· {count}</span>
          )}
          {badge}
        </div>
        {sub && (
  ...
  return (
    ...
    >
            ...
            <div>
              {SEED_DRAFT.map((f) => (
                ...
                >
                  ...
                  {f.state === "unset" ? (
                    <div className="muted text-xs">{f.unsetHint}</div>
                  ) : (
                    <div
                      style={{
                        fontSize: 12.5,
              ...
              <div key={u.id} className="unresolved-row">
                <div className="left">
                  ...
                  <div>
                    ...
                    <div className="muted text-xs">{u.field}</div>
                  </div>
                </div>
            ...
            WARNINGS.map((w) => (
              ...
              >
                ...
                <div>
                  ...
                  <div className="ink-2 text-xs" style={{ lineHeight: 1.55 }}>
                    {w.detail}
                  </div>
      ...
      >
        ...
        <div className="muted text-xs" style={{ flex: 1, lineHeight: 1.4 }}>
          Blocker 1 件 · 未設定 2 件
        </div>
