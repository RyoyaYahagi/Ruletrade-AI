      ...
      <div className="app-header">
        <div className="tool-row" style={{ flex: 1 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            ...
            <span className="muted text-xs" style={{ marginLeft: 2 }}>
              / ルール設計
            </span>
          </div>
        ...
        <div className="subhead-row">
          ...
          >
            ...
            >
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                <span className="muted text-xs">東証プライム</span>
                <span className="text-xs" style={{ color: "var(--faint)" }}>
                  ·
                </span>
                <span className="muted text-xs">電気機器</span>
                <span className="text-xs" style={{ color: "var(--faint)" }}>
                  ·
                </span>
                <span className="muted mono text-xs">
                  JPY 13,420{" "}
                  <span style={{ color: "var(--muted-2)" }}>+0.6%</span>
                </span>
              </div>
            </div>
          </div>
  ...
  return (
    <div className="card">
      <div className="card-header">
        <h3>
          次の質問 · {question.idx} / {question.total}
        </h3>
        <span className="muted text-xs">
          残り {question.total - question.idx + 1} 問
        </span>
      </div>
      ...
      >
        ...
        >
          ...
          <div style={{ flex: 1 }} />
          <span className="muted text-xs">
            回答は <span className="kbd">⌘</span> <span className="kbd">↵</span>
          </span>
        </div>
      </div>
    </div>
    ...
    <div className="draft-field" id={`field-${id}`}>
      <div className="draft-field-head">
        ...
        <div className="draft-field-actions">
          <button className="btn btn-sm btn-ghost" title="編集">
            <I.Edit />
          </button>
          {state !== "set" && (
            <button
              className="btn btn-sm"
              onClick={() => onFocusQuestion && onFocusQuestion(id)}
            >
              次に決める <I.ArrowRight />
            </button>
          )}
      ...
      <div className="card-header">
        ...
        <div style={{ display: "flex", gap: 6, alignItems: "center" }}>
          <span className="muted text-xs">
            10項目中{" "}
            <span className="mono">
              {draft.filter((f) => f.state === "set").length}
            </span>{" "}
            設定済み
          </span>
          <button className="btn btn-sm btn-ghost">
  ...
  return (
    <div className="rail-section">
      <div className="card-header">
        ...
        <span className="muted text-xs">前回 +6</span>
      </div>
      <div
        className="card-body"
        ...
        {breakdown.map((b, i) => (
          ...
          >
            ...
            <span
              ...
              style={{
                color:
                  b.score === b.max ? "var(--emerald-ink)" : "var(--muted)",
              }}
            >
              {b.score} / {b.max}
            </span>
          ...
          <div key={it.id} className="unresolved-row">
            <div className="left">
              ...
              <div style={{ minWidth: 0 }}>
                ...
                <div className="muted text-xs">{it.field}</div>
              </div>
            </div>
  ...
  return (
    <div className="rail-section">
      <div className="card-header">
        <h3>AIレビュー</h3>
        <span className="muted text-xs">
          {items.filter((i) => i.sev === "Blocker").length} Blocker ·{" "}
          {items.filter((i) => i.sev === "Warning").length} Warning ·{" "}
          {items.filter((i) => i.sev === "Info").length} Info
        </span>
      </div>
      <div>
        {items.map((w) => (
          <div key={w.id} className="severity-row">
            ...
            <div style={{ minWidth: 0 }}>
              ...
              <div className="ink-2 text-sm" style={{ lineHeight: 1.6 }}>
                {w.detail}
              </div>
              <div
                style={{
              ...
              >
                <span className="muted text-xs">
                  担当: <span style={{ color: "var(--ink-2)" }}>{w.owner}</span>
                </span>
                <span className="muted text-xs">
                  対象:{" "}
                ...
                <span className="muted text-xs">{w.time}</span>
              </div>
            </div>
    ...
    <div className="rail-section">
      ...
      <div className="evidence-grid">
        <div className="evidence-cell">
          ...
          <div className={`v ${verified ? "" : "muted"}`}>
            {verified ? evidence.window : "未実施"}
          </div>
        </div>
        <div className="evidence-cell">
...
function ApprovalBoundaryPanel({
  ...
  return (
    ...
    >
      ...
      >
        <p className="ink-2 text-sm" style={{ margin: 0, lineHeight: 1.6 }}>
