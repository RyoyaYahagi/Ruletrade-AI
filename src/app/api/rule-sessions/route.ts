...
import { createRuleSession, listRuleSessions } from "@/features/rules/services/rule-session-service";
...
export async function POST(request: Request) {
  ...
  try {
    ...
    const input = await validateJsonRequest(request, CreateRuleSessionRequestSchema);
